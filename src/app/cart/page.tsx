          ...
          <div className="lg:w-2/3">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                {items.map((item) => (
                  <li key={item.id} className="p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      <div className="flex flex-col items-end"><p className="text-[#A3292E] font-bold text-lg">{item.price} ج.م</p><p className="text-green-700 font-bold text-lg" dir="ltr">${(Number(item.price) / 52.13).toFixed(2)}</p></div>
                      <button
              ...
              <div className="p-6 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
                ...
                <div className="flex flex-col items-end"><span className="text-3xl font-black text-[#A3292E]">{totalPrice} ج.م</span><span className="text-green-700 font-black text-3xl" dir="ltr">${(Number(totalPrice) / 52.13).toFixed(2)}</span></div>
              </div>
            </div>
          </div>
